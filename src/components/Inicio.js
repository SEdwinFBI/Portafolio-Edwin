...
import devGif from '../img/devAnimationGif.gif'
    ...
    <section id='hero' className={Style.section_hero} >
      ...
      <div className={Style.hero_contenido}>
        ...
        <div className={Style.btn} >
          ...
          <a href="https://www.linkedin.com/in/santos-edwin-fernando-baquiax-ixchajchal/" target='blank'>
            <button  >
          ...
          <a href="https://wa.link/tg4f95" target='blank'>
            <button  >
        ...
        <div >
          ...
          <img className={Style.devImg}src={devGif} alt="" />
        </div>
      </div>
