...
const Proyectos = () => {
  const efectoScroll = "fade-down";

  const duracionEfecto = 1500;
  return (
    <section className={estilos.section_proyectos} id="works">
      ...
      <div>
        {/*inicio parte 1*/}
        <h2 className="text-center">Proyectos Full stack</h2>
        <hr />
      ...
      <div className="p1">
        ...
        <div className="row row-cols-1 row-cols-sm-3 ">
          ...
          <div>
            {/*div */}
            <Card
              imagenUrl="https://m.media-amazon.com/images/I/51HrrEbfYWL._AC_SL1500_.jpg"
              titulo="Stick Lamp"
