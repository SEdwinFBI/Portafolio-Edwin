    ...
    <section id="hero" className={Style.section_hero}>
      <div className={Style.hero_contenido}>
        <h1>
          Hola, soy
          <br />
          <span> Edwin Baquiax</span>{" "}
          <span className={Style.tildeo}>&#160;</span>
        </h1>
        ...
        <div className={Style.btn}>
          <a
            className="col"
            href="https://drive.google.com/file/d/1lx_QxmUxS4ottMKH51pzxlk-BzgGsIQW/view?usp=drive_link"
            target="blank"
          >
          ...
          <a
            className="col"
            href="https://www.linkedin.com/in/santos-edwin-fernando-baquiax-ixchajchal/"
            target="blank"
          >
            <button>
              <svg
        ...
        <div>
          <div className={Style.devImg}>
            <DotLottieReact
              src="https://lottie.host/1c64210c-30b8-4f5e-9a63-03a99cb1fae6/nxBBe9J8jg.lottie"
              loop
              autoplay
